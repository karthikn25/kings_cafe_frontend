        ...
        <div id="add-container">
          ...
          <div id="add-box-container">
            <div id="add-box">
              ...
              <div id="add-field">
                <input type="text" placeholder="name" name="foodName" onChange={handleChange} value={foodDetails.foodName}/>
              </div>
              <div id="add-field">
              <input type="number" placeholder="Price" name="price" onChange={handleChange} value={foodDetails.price}/>
            </div>
              <div id="add-field">
                <textarea type="text" placeholder="Details of Recipe"  name="details" onChange={handleChange} value={foodDetails.details}/>
              </div>
              <div id="add-btn">
